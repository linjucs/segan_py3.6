...
python main.py --init_noise_std 0. --save_path mix_0db \
               --batch_size 16 --g_nl prelu --weights SEGAN-112144 \
...
#python evaluate.py calculate_pesq --workspace=16_$SAVE_PATH --speech_dir=../new_dataset/test_clean_new --te_snr=0
